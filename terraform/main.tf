# VPC Peering Demo - Hub-and-Spoke Topology
# This demo creates three VPCs in different regions with a hub-and-spoke peering architecture
# Primary (us-east-1) ↔ Tertiary (eu-west-2) ↔ Secondary (us-west-2)
...
# Internet Gateway for Tertiary VPC
...
# Associate route table with Tertiary subnet
...
# VPC Peering Connection (Primary to Tertiary)
...
# VPC Peering Connection Accepter (Tertiary accepts from Primary)
...
# VPC Peering Connection (Secondary to Tertiary)
...
# VPC Peering Connection Accepter (Tertiary accepts from Secondary)
...
# Add route to Tertiary VPC in Primary route table
...
# Add route to Primary VPC in Tertiary route table
...
# Add route to Tertiary VPC in Secondary route table
...
# Add route to Secondary VPC in Tertiary route table
...
# Security Group for Tertiary VPC EC2 instance
